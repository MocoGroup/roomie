...
class EvaluationServiceTest {
    ...
    @Mock
    private PropertyEvaluationRepository evaluationRepository;
    ...
    void createEvaluation_ShouldThrowException_WhenNoValidContract() {
        ...
        assertEquals(HttpStatus.FORBIDDEN, exception.getStatusCode());
        assertEquals("Apenas estudantes com contrato neste imóvel podem avaliá-lo.", exception.getReason());
    }
    ...
    // Caminho de Sucesso para obter avaliações de um imóvel sem avaliações locais (mas com média e contagem)
    @Test

...
class PropertyServiceTest {
    ...
    @Test
    @DisplayName("Deve lançar erro 401 Unauthorized se o usuário não estiver autenticado (isAuthenticated false)")
    ...
    @Test
    @DisplayName("Deve lançar erro 404 NotFound se imóvel não for encontrado ao tentar colocar em rascunho")
    ...
    @Test
    @DisplayName("Deve lançar erro 403 Forbidden se o usuário tentar atualizar um imóvel de outro dono")
    ...
    @Test
    @DisplayName("Deve atualizar o imóvel mantendo a lista original caso mande novas fotos como lista vazia")
